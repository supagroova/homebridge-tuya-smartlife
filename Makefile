.PHONY: help build lint typecheck test coverage tdd-audit lockfile-check fmt check
...
help:
	...
	@echo "  make check          Full gate: lockfile-check + lint + typecheck + tdd-audit + test"
...
check: lockfile-check lint typecheck tdd-audit test
