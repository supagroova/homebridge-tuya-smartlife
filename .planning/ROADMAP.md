...
- [ ] **Phase 1: Project Scaffolding & TDD Gates** - TypeScript Homebridge plugin skeleton + TDD enforcement harness + CI + `/ship`
...
|-------|----------------|--------|-----------|
| 1. Project Scaffolding & TDD Gates | 2/3 | In Progress|  |
